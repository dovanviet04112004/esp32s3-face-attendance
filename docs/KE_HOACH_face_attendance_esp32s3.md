...
| LCC-FASD | Bản Kaggle [`faber24/lcc-fasd`](https://www.kaggle.com/datasets/faber24/lcc-fasd): đăng nhập rồi bấm Download, không form; [bài báo gốc](https://csit.am/2019/proceedings/PRIP/PRIP3.pdf) (ID R&D 2019) không vào được — **chưa tải**, manifest đã ghi | 5,19 GB PNG, bố cục `LCC_FASD/LCC_FASD_{training,development,evaluation}/{real,spoof}/` | test khác miền — thật, in, phát lại **chụp lại bằng điện thoại trong phòng thường**, thật và giả cùng cảnh. Xét trộn vào train **sau** khi chấm chéo |
