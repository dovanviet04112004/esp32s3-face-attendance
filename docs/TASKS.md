...
| **E14-T9** | **Đo `LCD_HOLE_INSET`** (§2.3A) — từ tâm lỗ vít tới mép tấm màn. Hàng chân ngang hàng với hai lỗ đầu dưới nên đo lỗ là chốt luôn cả `LCD_HEADER_INSET`. Vít M2.5 trong lỗ Ø2,7 chỉ có 0,1 mm khe nên lệch 1 mm là không bắt được; bốn lỗ không đối xứng thì phải khai từng lỗ. **Thứ tự 14 chân XONG 12/09**, kích thước tấm màn 107 × 61 XONG 12/09 | §2.3A bỏ dấu 🔬; sinh lại PCB và bốn lỗ tự dịch theo | E14-T8 |
