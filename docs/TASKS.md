...
| **E14-T9** | **Đo `LCD_HOLE_INSET`** (§2.3A) — từ tâm lỗ vít tới mép tấm màn. Hàng chân ngang hàng với hai lỗ đầu dưới nên đo lỗ là chốt luôn cả `LCD_HEADER_INSET`. Vít M3 qua lỗ Ø3,5 của màn và Ø3,2 của board đế chỉ xê dịch được 0,35 mm nên lệch 1 mm là không bắt được; bốn lỗ không đối xứng thì phải khai từng lỗ. **Thứ tự 14 chân XONG 12/09**, kích thước tấm màn 107 × 61 XONG 12/09 | §2.3A bỏ dấu 🔬; sinh lại PCB và bốn lỗ tự dịch theo | E14-T8 |
