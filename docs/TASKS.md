...
| E3-T8 | Thu tập spoof tự thu bằng chính board: in ảnh, màn hình điện thoại, màn hình laptop, mặt nạ giấy, cộng mặt thật — **chỉ để kiểm chất lượng, không train** (chốt 11/09). Bộ `phone_eval` hiện là 5 clip = 5 điều kiện; cần phủ thêm phòng, giờ trong ngày, người, vật liệu. Hai bộ công khai chờ mạng, manifest đã ghi: LCC-FASD (bản Kaggle 5,19 GB, tải tay sau đăng nhập) và SynthASpoof (Drive công khai 12 GB, script tải được) — chấm chéo trước, trộn vào train sau nếu đáng | Vài chục clip ngắn phủ đủ điều kiện, mỗi clip một điều kiện | E3-T7 |
