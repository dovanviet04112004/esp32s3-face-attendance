...
extern const uint8_t kiosk_ui_15_line_h;
extern const uint8_t kiosk_ui_15_ascent;
extern const uint16_t kiosk_ui_15_count;
extern const uint8_t kiosk_ui_15_bitmap[];
extern const kiosk_glyph_t kiosk_ui_15_glyphs[];
