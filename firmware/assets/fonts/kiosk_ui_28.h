...
extern const uint8_t kiosk_ui_28_line_h;
extern const uint8_t kiosk_ui_28_ascent;
extern const uint16_t kiosk_ui_28_count;
extern const uint8_t kiosk_ui_28_bitmap[];
extern const kiosk_glyph_t kiosk_ui_28_glyphs[];
