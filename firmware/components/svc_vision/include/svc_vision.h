...
typedef enum {
    SVC_VISION_NONE = 0,                  // nothing new: tracking, or a verification mid-way
...
/** Reserve the crop buffers in PSRAM and take the thresholds.
 *  @ctx task | blocking | call after ai_engine_init and svc_facedb_init
 *  @ret ESP_OK | ESP_ERR_INVALID_STATE on a second call | ESP_ERR_NO_MEM | ESP_ERR_INVALID_ARG
 */
 ...
 *  @ctx ai_task | blocking, detect plus at most one more model (KEHOACH 4.5.5d)
