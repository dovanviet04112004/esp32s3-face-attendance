...
|---|---|---|---|
| **0,40 mm** | 53 | rải khắp board | **Via** xuyên lớp — không cắm gì, chỉ nối đồng mặt trước với mặt sau |
...
**Board 2 lớp**, dày 1,6 mm. Đường nguồn 1,0 mm đi mặt sau, tín hiệu 0,25 mm đi mặt trước; đường nào bí thì lật mặt, và chỗ lật là một via.

Vành đồng mỏng nhất **0,20 mm** (via); mỏng nhất trong các lỗ cắm là **0,35 mm** (các lỗ 1,00). `tools/check_pcb.py` chặn lỗ dưới 0,30 mm và
