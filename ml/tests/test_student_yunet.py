"""E4-T3: the YuNet student architecture, its priors and its three branches."""
...
from facepipe.tasks.detection.student import (
    STRIDES,
    YuNet,
    YuNetBackbone,
    feature_sizes,
...
from facepipe.tasks.detection.student.blocks import ConvDPUnit
...
def test_shipped_config_builds_the_model() -> None:
    config = load_config(ML_ROOT / "configs/detection/student_yunet.yaml")
